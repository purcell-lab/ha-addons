...
export SIDECAR_FORECAST_HORIZON_DAYS="$(bashio::config 'forecast_horizon_days')"
export SIDECAR_FORECAST_HORIZON_HOURS="$(bashio::config 'forecast_horizon_hours')"
export SIDECAR_CHAIN_SEAM_DAYS="$(bashio::config 'chain_seam_days')"
export SIDECAR_CHAIN_BLEND_WINDOW_HOURS="$(bashio::config 'chain_blend_window_hours')"
...
export SIDECAR_HYBRID_CROSSOVER_HOURS="$(bashio::config 'hybrid_crossover_hours')"
export SIDECAR_HYBRID_BLEND_WINDOW_HOURS="$(bashio::config 'hybrid_blend_window_hours')"
export SIDECAR_HYBRID_BLEND_ENABLED="$(bashio::config 'hybrid_blend_enabled')"
export SIDECAR_CALIBRATOR_ADJACENCY_ALPHA="$(bashio::config 'calibrator_adjacency_alpha')"
